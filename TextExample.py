...
#############
"""
You're basically in a dungeon, trying to solve each side of the cube to "break it open" and escape.
Here's a diagram!					
----------------------------------------------------
        North -v      _.-+							
                 _.-""     '						
...
cube = {
    ...
    'east': {
        ...
        INFO: "A handsome-looking,gray-haired man sits on the plastic chair.\nHis eyes are express Power and his appearance looks quite dangerous.",
        PUZZLE: "The handsome-looking man asks,\n'What  is the POWER that beats talent?'",
        SOLVED: "motivation",
        SIDE_UP: 'north',
        SIDE_DOWN: 'south',
        SIDE_LEFT: 'ground',
    ...
    'west': {
        ...
        INFO: "A handsome-looking,gray-haired(too)man is hiding among some cactus.\nIn his appeareance you can say he is little crazy",
        PUZZLE: "The gray-haired man asks,\n'The figure that creating triangle with good cheesy smell?'",
        SOLVED: "pizza",
        SIDE_UP: 'north',
        SIDE_DOWN: 'south',
        SIDE_LEFT: 'top',
...
def title_screen():
    ...
    print('#' * 45)
    print('# Welcome to this text-based puzzle RPG #')
    print('#' * 45)
    print("                 .: Play :.                  ")
    print("                 .: Help :.                  ")
    print("                 .: Quit :.                  ")
...
def setup_game():
    ...
    good_adj = ['good', 'great', 'rohit', 'happy', 'aight', 'understanding', 'great', 'alright', 'calm', 'confident',
                ...
                'elated', '1738', 'love', 'interested', 'positive', 'strong', 'loving']
    ...
    bad_adj = ['bad', 'meh', 'sad', 'hungry', 'unpleasant', 'feelings', 'angry', 'depressed', 'confused', 'helpless',
               ...
               'appalled', 'cowardly', 'humiliated', 'quaking', 'wronged', 'menaced', 'alienated', 'wary']
    ...
    speech5 = "Luckily, I've left you in a little dungeon.  Hopefully you can escape this dungeon.\n"
    speech6 = "Heh. Heh.. Heh...\n"
